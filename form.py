...
df = pd.read_excel(r'C:\\\Users\Laviz Pandey\Documents\Form.xlsx')
...
while True:
    ...
    if event == 'Submit':
        ...
        df.to_excel(r'C:\\\Users\Laviz Pandey\Documents\Form.xlsx', index=False)
        window.close()
        ...
        sg.popup_timed(
            "Thanks. Your Data has been saved. The information will be provided in your Email if there is any Flood Alert.",
